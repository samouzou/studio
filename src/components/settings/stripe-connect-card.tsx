...
const CREATE_STRIPE_CONNECTED_ACCOUNT_FUNCTION_URL = "https://us-central1-sololedger-lite.cloudfunctions.net/createStripeConnectedAccount";
const CREATE_STRIPE_ACCOUNT_LINK_FUNCTION_URL = "https://us-central1-sololedger-lite.cloudfunctions.net/createStripeAccountLink";
